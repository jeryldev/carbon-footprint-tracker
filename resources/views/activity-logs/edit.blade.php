                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('activity-logs.update', $activityLog) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="date" class="block mt-1 w-full" type="date" name="date" :value="old('date', $activityLog->date->format('Y-m-d'))" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="transport_distance" class="block mt-1 w-full" type="number" name="transport_distance" :value="old('transport_distance', $activityLog->transport_distance)" required step="0.1" min="0" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="electricity_usage" class="block mt-1 w-full" type="number" name="electricity_usage" :value="old('electricity_usage', $activityLog->electricity_usage)" step="0.1" min="0" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="waste_generation" class="block mt-1 w-full" type="number" name="waste_generation" :value="old('waste_generation', $activityLog->waste_generation)" step="0.1" min="0" />
